...
class EnergySolarPanelCounters9kw extends Model {
    public id!: number
...
EnergySolarPanelCounters9kw.init(
    {
        id: {
    ...
    {
        sequelize,
        tableName: "countersSolarPanel9kw",
        createdAt: "createdAt",
        updatedAt: "updatedAt"
    }
)

export default EnergySolarPanelCounters9kw
